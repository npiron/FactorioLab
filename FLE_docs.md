# Factorio Learning Environment docs (scraped)

- Start URL: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/
- Pages scraped: 16
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/getting_started/installation.html
...
For rendering Factorio with graphics, you need to set up a Factorio client:
  ...
  1. **Purchase and Install Factorio**
     ...
     - Purchase from the [official website](https://www.factorio.com/) (recommended) or on Steam
...
## Next Steps
  ...
  - Continue to [Quickstart](quickstart.html) to learn how to use FLE

  - See [Troubleshooting](troubleshooting.html) if you encounter issues

---

## Quickstart — Factorio Learning Environment 0.3.0 documentation

Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/getting_started/quickstart.html
...
## Next Steps
  ...
  - Learn about the [Environment Overview](../environment/overview.html) and how agents interact with it

  - Explore the [Tools Overview](../tools/overview.html) available to agents

  - Check out the [Gym Environment Registry](../environment/gym_registry.html) for available tasks

---

## Troubleshooting — Factorio Learning Environment 0.3.0 documentation

Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/getting_started/troubleshooting.html
...
If you continue to experience issues:
  ...
  1. Check the [GitHub Issues](https://github.com/JackHopkins/factorio-learning-environment/issues)

  2. Join the [Discord (#factorio-learning-env)](https://discord.gg/zKaV2skewa)

  3. Review the [Project Structure](../project_structure.html) to understand the codebase layout
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/environment/overview.html
...
Agents are provided with the Python standard library and an API comprising [Tools Overview](../tools/overview.html) that they can use.
...
## Next Steps
  ...
  - Explore the [Gym Environment Registry](gym_registry.html) to see all available tasks

  - Learn about [Tools Overview](../tools/overview.html) available to agents

  - See [Quickstart](../getting_started/quickstart.html) for usage examples

---

## Gym Environment Registry — Factorio Learning Environment 0.3.0 documentation

Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/environment/gym_registry.html
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/tools/overview.html

# Tools Overview

Agents interact with the game using _tools_ , which represent a narrow API into the game. Tools are functions that agents can call to perform actions and retrieve information.
...
## Next Steps
  ...
  - See [Core Tools Reference](core_tools.html) for detailed documentation on each tool

  - Learn how to [Creating Custom Tools](custom_tools.html) for specialized functionality

  - Review the [Environment Overview](../environment/overview.html) to understand the full context

---

## Core Tools Reference — Factorio Learning Environment 0.3.0 documentation

Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/tools/core_tools.html
...
## Next Steps
  ...
  - Review [Tools Overview](overview.html) for architectural details
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/tools/custom_tools.html
...
## Next Steps
  ...
  - Review [Core Tools Reference](core_tools.html) for implementation patterns

  - See [Tools Overview](overview.html) for architecture details

  - Check the [Factorio Lua API](https://lua-api.factorio.com/1.1.110/)

  - Join the [Discord](https://discord.gg/zKaV2skewa) for help

---

## Model Context Protocol (MCP) — Factorio Learning Environment 0.3.0 documentation

Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/advanced/mcp.html

# Model Context Protocol (MCP)

FLE supports the [Model Context Protocol](https://github.com/modelcontextprotocol) (MCP) to enable LLM reasoning models to invoke tools directly.
...
You can create custom MCP-specific tools by following the [Creating Custom Tools](../tools/custom_tools.html) guide. Tools created this way are automatically exposed via MCP.
...
## Next Steps
  ...
  - Review [Tools Overview](../tools/overview.html) to understand available tools

  - See [Creating Custom Tools](../tools/custom_tools.html) to create MCP-compatible tools
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/advanced/sprites.html
...
## Next Steps
  ...
  - Learn about [Tools Overview](../tools/overview.html) for non-visual interactions

  - See the [Visual Agent example](https://github.com/JackHopkins/factorio-learning-environment/tree/main/examples)

  - Review [Environment Overview](../environment/overview.html) for context

---

## Database Configuration — Factorio Learning Environment 0.3.0 documentation

Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/advanced/database.html
...
## Next Steps
  ...
  - Review [Quickstart](../getting_started/quickstart.html) for basic usage

  - See [Environment Overview](../environment/overview.html) for environment context

  - Check [Troubleshooting](../getting_started/troubleshooting.html) for common issues

---

## Project Structure — Factorio Learning Environment 0.3.0 documentation

Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/project_structure.html
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/genindex.html
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/search.html
...
Source: https://jackhopkins.github.io/factorio-learning-environment/sphinx/build/html/index.html
